  ...
  const body = {
        filter: {
                and: [
                  ...
                  { property: 'Referencia', files: { is_not_empty: true } },
  ...
  const items = (data.results || [])
      .map((page) => {
              const props = page.properties || {};
                 ...
                 const filesProp = props['Referencia']?.files || [];
